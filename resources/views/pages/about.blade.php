			...
			<div class="row row-eq-height">
				...
				<div class="col-lg-6">
					<div class="intro_content">
						<div class="section_title_container">
							<div class="section_subtitle">Urban Village</div>
						...
						<div style="margin-top: 20px;">
                            <a href="https://www.rightmove.co.uk/estate-agents/agent/Urban-Village/London-60210.html">
                                <img width="100%" class="img-responsive" src="{{ asset('images/right-move-banner.jpg') }}" alt="Urban Village Homes on Right-move"/>
                            </a>
                        </div>
					</div>
				</div>
				...
				<div class="col-lg-6 intro_col">
					<div class="intro_image">
                        <iframe width="560" height="315" src="https://www.youtube.com/embed/34l5IkFe8Y4" frameborder="0" allow="accelerometer; autoplay; encrypted-media; gyroscope; picture-in-picture" allowfullscreen></iframe>
					</div>
				</div>
