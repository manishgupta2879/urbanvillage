...
<div aria-label="breadcrumb">
    <ol class="breadcrumb">
        ...
        <li class="breadcrumb-item active" aria-current="page">Home Staging Valuation Request</li>
    </ol>
</div>
        ...
        <div class="row move_up_top-2">
            <div class="col-12">
                <div class="section_title_container ">
                    <br/><br/>
                    <h1 class="main-title">Free Home Staging Consultation Request</h1>
                    <p class="empty-pr">&nbsp;</p>
        ...
        <div class="row contact_row">
            ...
            <div class="col-lg-12 contact_col">
                <div class="contact_form_container">
                    <!-- Contact - About -->
                    <form action="{{url('send-home-staging-consultation-request')}}" method="post" class="contact_form text-center" id="contact_form">
                        {{csrf_field()}}
                        <div class="row">
