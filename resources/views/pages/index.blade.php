                        ...
                        <div class="col-md-12">
                            ...
                            <div class="sold-cards">
                                <p>
                                    ...
                                    <br>
                                    {!! str_limit($property->displayAddress, $limit = 25, $end = '...')??'&nbsp' !!}
                                </p>
                                <div class="d-flex justify-content-between align-items-center">
                                    <p class="">{{ $property->propertyStyle }}</p>
...
<section class="Why-work-with-us">
    <div class="container">
        <div class="profile-card  row">
            ...
            <div class="col-12 col-md-6 p-0 p-lg-3">
                <img src="http://127.0.0.1:8000/images/about-us/MaskGroup44.png" alt="Suzanne Vincent" class="profile-image ms-3">
            </div>
        </div>
    </div>
</section>
